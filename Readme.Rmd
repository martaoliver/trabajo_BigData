...
El documento con el código para hacer mi trabajo se encuentra en el archivo `index.Rmd` del repo. La versión final del trabajo puede visualizarse en: <https://martaoliver.github.io/trabajo_BigData/>.
