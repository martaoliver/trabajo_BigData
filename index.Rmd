...
author: "tu-nombre(tu-mail@alumni.uv.es). Universitat de València"
date: "Diciembre de 2019 (actualizado el `r format(Sys.time(), '%d-%m-%Y')`)"
output:
  html_document:
    theme: paper
    highlight: textmate 
...
```{r, eval = FALSE}
rio::export(iris, "./datos/iris.rds")
```
